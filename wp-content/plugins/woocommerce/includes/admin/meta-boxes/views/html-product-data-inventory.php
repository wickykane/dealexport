...
<div id="inventory_product_data" class="panel woocommerce_options_panel hidden">
	...
	<div class="show_if_out_of_stock">
		<?php
		woocommerce_wp_text_input(
			array(
				'id'          => '_out_of_stock_message',
				'value'       => get_post_meta( $product_object->get_id(), '_out_of_stock_message', true ),
				'label'       => '<abbr title="' . esc_attr__('Out of stock Message', 'woocommerce') . '">' . esc_html__('Out of stock Message', 'woocommerce') . '</abbr>',
				'desc_tip'    => true,
				'description' => __('Define the message to show if out of stock', 'woocommerce'),
			)
		);
		?>
	</div>
