            ...
            <div class="panel">
                <h2 class="box-heading"><?php
                    if (SET_GOOGLE_MAP == 'online') {
                        echo 'Online users';
                    } else if(SET_GOOGLE_MAP == 'all'){
                        echo 'Top 10 countries';
                    }else if(SET_GOOGLE_MAP == 'this_month'){
                        echo 'This month visitors';
                    }else if(SET_GOOGLE_MAP == 'past_month'){
                ...
                <div class="panelcontent">
                    <table width="95%" border="0" cellspacing="0" id="summary_statistics">
                        ...
                        <tr>
                            ...
                            <td  class="values"><span id="today_visitors"><?php echo ahc_free_NumFormat($ahc_sum_stat['today']['visitors']); ?></span></td>
                            <td  class="values"><span id="today_visits"><?php echo ahc_free_NumFormat($ahc_sum_stat['today']['visits']); ?></span></td>
                        </tr>

                        <tr>
                            <td><b><?php echo ahc_yesterday ?></b></td>
                            <td  class="values"><?php echo ahc_free_NumFormat($ahc_sum_stat['yesterday']['visitors']); ?></td>
                            <td  class="values"><?php echo ahc_free_NumFormat($ahc_sum_stat['yesterday']['visits']); ?></td>
                        </tr>

                        <tr>
                            <td><b><?php echo ahc_this_week ?></b></td>
                            <td  class="values"><?php echo ahc_free_NumFormat($ahc_sum_stat['week']['visitors']); ?></td>
                            <td  class="values"><?php echo ahc_free_NumFormat($ahc_sum_stat['week']['visits']); ?></td>
                        </tr>

                        <tr>
                            <td><b><?php echo ahc_this_month ?></b></td>
                            <td  class="values"><?php echo ahc_free_NumFormat($ahc_sum_stat['month']['visitors']); ?></td>
                            <td  class="values"><?php echo ahc_free_NumFormat($ahc_sum_stat['month']['visits']); ?></td>
                        </tr>

                        <tr>
                            <td><b><?php echo ahc_this_yesr ?></b></td>
                            <td  class="values"><?php echo ahc_free_NumFormat($ahc_sum_stat['year']['visitors']); ?></td>
                            <td  class="values"><?php echo ahc_free_NumFormat($ahc_sum_stat['year']['visits']); ?></td>
                        </tr>

                        <tr>
                            <td style="color:#090"><strong><b><?php echo ahc_total ?></b></strong></td>
                            <td  class="values" style="color:#090"><strong><?php echo ahc_free_NumFormat($ahc_sum_stat['total']['visitors']); ?></strong></td>
                            <td  class="values" style="color:#090"><strong><?php echo ahc_free_NumFormat($ahc_sum_stat['total']['visits']); ?></strong></td>
                        </tr>
						</tbody>
                    </table>
                ...
                <div class="panelcontent">
                    <table width="95%" border="0" cellspacing="0" id="search_engine">
                        ...
                        if (is_array($alltimeSER)) {
                            foreach ($alltimeSER as $ser=>$v) {
                                ...
                                <tr>
                                    ...
                                    <td class="values"><?php echo ahc_free_NumFormat($v); ?></td>
                        ...
                        <tr>
                            ...
                            <td class="values" ><strong id="today_search"><?php echo ahc_free_NumFormat($tot_srch); ?></strong></td>
                        ...
                        if (is_array($tTitles) && count($tTitles) > 0) {
                            foreach ($tTitles as $t) {
                                ...
                                <tr>
                                    ...
                                    <td  class="values"><?php echo ahc_free_NumFormat($t['til_hits']); ?></td>
							...
							foreach ($lastSearchKeyWordsUsed as $searchWord) {
								...
								<tr>
									<td>
										...
										<span><img src="<?php echo plugins_url('/images/search_engines/' . $searchWord['srh_icon'], AHCFREE_PLUGIN_MAIN_FILE); ?>" border="0" width="22" height="22" title="<?php echo $searchWord['srh_name'] ?>" /></span>
										<span><img src="<?php echo plugins_url('/images/browsers/' . $searchWord['bsr_icon'], AHCFREE_PLUGIN_MAIN_FILE); ?>" border="0" width="20" height="20" title="<?php echo $searchWord['bsr_name'] ?>" /></span>
									</td>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ahc_getOnlineUsers()
        {
			...
			jQuery.ajax({
				...
				data: {
					'action': 'ahcfree_countOnlineusers',
				},
        ...
        setInterval(ahc_getOnlineUsers, <?php echo AHC_AJAX_CHECK ?>)
