                            ...
                            <div class="site-popup medium">
                                <form class="site-form element-form" method="POST" action="<?php echo AJAX_URL; ?>">
                                    <div class="field-wrap">
                                        <input type="text" name="shop_email" readonly="readonly" value="<?php echo esc_attr(ThemedbUser::$data['active']['profile']['billing_email']); ?>" />
                                        <input type="hidden" name="email" readonly="readonly" value="<?php echo esc_attr(ThemedbUser::$data['current']['email']); ?>" />
                                    </div>
                                    <div class="field-wrap">
