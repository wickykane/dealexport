        ...
        <div class="header-wrap clearfix">
                ...
                <div class="site-toolbar container">
                    <nav class="right language-menu">
                        <?php wp_nav_menu(array(
                            'theme_location' => 'top_menu', 'menu' => 61, 'menu_class' => 'ui-beacon-nav ui-beacon', 'link_after' => '<i class="ui-beacon-hollow-arrow"><em></em><b></b></i>', 'walker' => new db_Walker_Nav_Menu()
                        )); ?>
                    </nav>
                    ...
                    <nav class="right">
                        <?php wp_nav_menu(array(
                            'theme_location' => 'top_menu', 'menu_class' => 'ui-beacon-nav ui-beacon', 'link_after' => '<i class="ui-beacon-hollow-arrow"><em></em><b></b></i>', 'walker' => new db_Walker_Nav_Menu()
                        )); ?>
                    </nav>
                    <!-- /top menu -->
                </div>
            ...
            <div class="main-header">
                <div class="header-search-container">
                    <form role="search" method="GET" action="https://dealexport.amagumolabs.io/">
                        <div class="header-search-close"><a class="header-search-close-link" href="#"><svg viewBox="0 0  24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                                    <path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z" /></svg></a></div>
                        ...
                        <div class="header-search-start"><a class="header-search-start-link" href="#"><svg viewBox="0 0  24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                ...
                <div class="site-toolbar container">
                    <div class="icon-nav">
                        <a class="icon-nav-item search-item" href="#" title="<?php _e('Search', 'dealexport'); ?>"><svg xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                                <path d="M15.853 16.56c-1.683 1.517-3.911 2.44-6.353 2.44-5.243 0-9.5-4.257-9.5-9.5s4.257-9.5 9.5-9.5 9.5 4.257 9.5 9.5c0 2.442-.923 4.67-2.44 6.353l7.44 7.44-.707.707-7.44-7.44zm-6.353-15.56c4.691 0 8.5 3.809 8.5 8.5s-3.809 8.5-8.5 8.5-8.5-3.809-8.5-8.5 3.809-8.5 8.5-8.5z" /></svg></a>
                        <a class="icon-nav-item cart-item" href="<?php echo ThemedbWoo::$woocommerce->cart->get_cart_url(); ?>" title="<?php _e('Shopping cart', 'dealexport'); ?>"><svg xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
                                ...
                                <div id="login_form">
                                    <div class="site-popup small">
                                        <form class="site-form element-form" method="POST" action="<?php echo AJAX_URL; ?>">
                                            ...
                                            <?php } ?>
                                            <a href="#password_form" class="element-button element-colorbox" title="<?php _e('Password Recovery', 'dealexport'); ?>"><span style="margin-right: 5px;" class="fa fa-life-ring"></span>
            ...
            <?php } else { ?>
                ...
                <!-- <div class="site-title">
                        <div class="container">
                            <span><?php //ThemedbInterface::renderPageTitle(); 
                                    ?></span>
                        </div>
                    </div> -->
                <!-- /title -->
