...
$options = array(
	...
	array(
		...
		'desc' => sprintf( __( 'Choose a Header from the list to replace with Global header in this page. All headers built by header builder are listerd here. %s', 'mk_framework' ), '<a id="_hb_header_builder_link" target="_blank" href="' . admin_url( 'admin.php?page=header-builder' ) . '">Launch Header Builder</a>.' ),
	...
	array(
		...
		'desc' => sprintf( __( 'This logo will be used when transparent header is enabled and your header skin is dark. <a href="%s" target="_blank">Learn more</a>', 'mk_framework' ), 'https://themes.artbees.net/docs/configuring-logos/' ),
		'id' => 'logo',
		'default' => '',
		'width' => 'logo_width',
		'type' => 'upload',
	...
	array(
		...
		'desc' => sprintf( __( 'This logo will be used when transparent header is enabled and your header is light skin. <a href="%s" target="_blank">Learn more</a>', 'mk_framework' ), 'https://themes.artbees.net/docs/configuring-logos/' ),
		'id' => 'light_logo',
		'default' => '',
	...
	array(
		...
		'desc' => sprintf( __( 'Use this option upload the sticky header logo. <a href="%s" target="_blank">Learn more</a>', 'mk_framework' ), 'https://themes.artbees.net/docs/configuring-logos/' ),
	...
	array(
		...
		'desc' => sprintf( __( 'Use this option to change your logo for mobile devices if your logo width is quite long to fit in mobile device screen. <a href="%s" target="_blank">Learn more</a>', 'mk_framework' ), 'https://themes.artbees.net/docs/configuring-logos/' ),
		'id' => 'responsive_logo',
		'default' => '',
