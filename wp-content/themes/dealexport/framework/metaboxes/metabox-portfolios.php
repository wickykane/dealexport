...
$options = array(
	...
	array(
		...
		'desc' => __( 'Enabling this option will remove padding after header and before footer. If you would like to enable it for pages throughout the site, consider setting the option in Theme Options => Portfolio => Portfolio Single Post.', 'mk_framework' ),
		'id' => '_padding',
		'default' => 'false',
		'type' => 'toggle',
	),
