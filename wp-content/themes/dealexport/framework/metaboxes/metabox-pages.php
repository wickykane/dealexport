...
$options = array(
	array(
		...
		'options' => array(
			...
			'full-width' => __( 'Full Width Layout', 'mk_framework' ),
		),
		'type' => 'select',
	),
	array(
	...
	array(
		...
		'desc' => __( 'Enabling this option will remove padding after header and before footer. If you would like to enable it for pages throughout the site, consider setting the option in Theme Options => Main Content => Layout &amp; Backgrounds.', 'mk_framework' ),
		'id' => '_padding',
		'default' => 'false',
		'type' => 'toggle',
	),
