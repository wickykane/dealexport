...
$options = array(
	...
	array(
		...
		'desc' => sprintf(
			__( 'Choose which menu location to be used in this page. If left blank, Primary Menu will be used. You should first %1$screate menu%2$s and then %3$sassign to menu locations%4$s', 'mk_framework' ),
	...
	array(
		...
		'desc' => __( 'You can create a custom sidebar, under Sidebar option and then assign the custom sidebar here to this post. later on you can customize which widgets to show up. <a target="blank" href="https://themes.artbees.net/video/jupiter-widgets-custom-sidebars/">CLICK HERE</a> for more information.', 'mk_framework' ),
		'id' => '_sidebar',
		'default' => '',
