 ...
 * @since       5.1
 * @since       5.9.7 Modified `cssAdminClass` function.
 * @package     artbees
 */
class WPBakeryShortCode_mk_page_section extends WPBakeryShortCode {
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		$controls_move = ' <a class="vc_control column_move vc_column-move" href="#" title="' . __( 'Drag Page Section to reorder', 'mk_framework' ) . '" data-vc-control="move"><i class="vc-composer-icon vc-c-icon-dragndrop"></i></a>';
		$controls_add = ' <a class="vc_control column_add vc_column-add" href="#" title="' . __( 'Add column', 'mk_framework' ) . '" data-vc-control="add"><i class="vc-composer-icon vc-c-icon-add"></i></a>';
		$controls_delete = '<a class="vc_control column_delete vc_column-delete" href="#" title="' . __( 'Delete this Page Section', 'mk_framework' ) . '" data-vc-control="delete"><i class="vc-composer-icon vc-c-icon-delete_empty"></i></a>';
		$controls_edit = ' <a class="vc_control column_edit vc_column-edit" href="#" title="' . __( 'Edit this Page Section', 'mk_framework' ) . '" data-vc-control="edit"><i class="vc-composer-icon vc-c-icon-mode_edit"></i></a>';
		$controls_clone = ' <a class="vc_control column_clone vc_column-clone" href="#" title="' . __( 'Clone this Page Section', 'mk_framework' ) . '" data-vc-control="clone"><i class="vc-composer-icon vc-c-icon-content_copy"></i></a>';

		$controls_toggle = ' <span class="vc_control vc_row_section_mark" title="' . __( 'Theme Page Section Element', 'mk_framework' ) . '">' . __( 'Page Section', 'mk_framework' ) . '</span><a class="vc_control column_toggle vc_column-toggle" href="#" title="' . __( 'Toggle Page Section', 'mk_framework' ) . '" data-vc-control="toggle"><i class="vc-composer-icon vc-c-icon-arrow_drop_down"></i></a>';
