                    ...
                    <div class="site-toolbar container">
                        ...
                        <nav class="header-menu element-menu">
                            <?php 
                                ...
                                wp_nav_menu(
                                    array(
                                        'theme_location' => 'main_menu_service', 
                                        'container_class' => 'menu',
//                                        'items_wrap' => '<ul id="%1$s" class="%2$s category_main_menu" data-taxonomy="product_cat">%3$s<li></li></ul>'
                                    )
                                ); 
...
//                                print_r($user);
                        	 ...
                        	 <span id="nav-menu-guest"  class='user-name right clearfix' >
                                ...
                                <a href="#login_form" class="element-colorbox signInBtn"><?php _e('Sign In', 'dealexport'); ?></a>
