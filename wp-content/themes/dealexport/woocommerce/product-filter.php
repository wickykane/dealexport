...
//    ?>
<!--    <li class="dropdown">-->
<!--        <a href="#" data-toggle="dropdown">--><?php //_e('Level of Expertise', 'dealexport') ?><!--<i class="icon-arrow"></i></a>-->
...
//    ?>
<!--    <li class="dropdown">-->
<!--        <a href="#" data-toggle="dropdown">--><?php //_e('Level of Development', 'dealexport') ?><!--<i class="icon-arrow"></i></a>-->
...
//    ?>
<!--    <li class="dropdown">-->
<!--        <a href="#" data-toggle="dropdown">--><?php //_e('Service Provider', 'dealexport') ?><!--<i class="icon-arrow"></i></a>-->
