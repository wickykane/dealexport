...
<div id="content">
    <div class="eightcol column">
        ...
        <div class="element-title indented">
            <h2><?php echo __('Order from', 'dealexport').' '.$title; ?></h2>
        </div>
        <?php } ?>
                    ...
                    foreach(WC()->cart->get_cart() as $cart_item_key => $cart_item){
                        ...
                        <tr class="<?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                            ...
                            <td class="product-remove">
                                <?php
                                echo apply_filters('woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="element-button small square secondary" title="%s"><span class="fa fa-times"></span></a>', esc_url(WC()->cart->get_remove_url($cart_item_key)), __('Remove this item', 'dealexport')), $cart_item_key);
                                ?>
                            </td>
                        </tr>
                        <?php
