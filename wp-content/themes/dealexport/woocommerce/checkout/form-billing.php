    ...
    if (is_user_logged_in()) { ?>
      <div>
        ...
        <div class="billing-user-form">
          ...
          <?php endforeach; ?>
          <button style="width: inherit; float: right; margin-bottom: 1rem;" class="update-billing-profile-btn button cart-page-summary-footer-button alt">Enregistrer</button>
