	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-total"><?php esc_html_e( 'Total TTC', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
				...
				<?php foreach ( $order->get_items() as $item_id => $item ) : ?>
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
						<td class="product-name">
							<?php
								echo apply_filters( 'woocommerce_order_item_name', esc_html( qtranxf_gettext($item->get_name()) ), $item, false ); // @codingStandardsIgnoreLine
								$shop = get_field('de_shop', $item['product_id']);
