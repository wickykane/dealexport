...
<div class="item-options clearfix add-to-cart-form">
<form class="cart" action="<?php echo themedb_url(); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="btn-group-wrap">
  		<div class="btn-group">
		    <a href="#" class="element-button like-button aligncenter" title="<?php _e('Like', 'dealexport'); ?>" style="width: 132px;">
		        <span class="fa fa-heart large"></span>
		        <span class="like-text"><?php _e('Like', 'dealexport'); ?></span>
		    </a>
		    
		    <a href="#" class="element-button cart-button aligncenter" title="<?php _e('Cart', 'dealexport'); ?>">
