<div class="widget widget-slider sidebar-widget">
    <div class="widget-title">
        <h4><?php _e('New Items', 'dealexport'); ?></h4>
    </div>
    <?php if(empty(ThemedbUser::$data['current']['updates'])) { ?>
    <span class="secondary"><?php _e('No shops favorited yet.', 'dealexport'); ?></span>
    <?php } else { ?>
    <div class="element-slider" data-effect="slide" data-pause="0" data-speed="0">
        <ul>
            <?php
            $counter=0;
            foreach(ThemedbUser::$data['current']['updates'] as $product) {
