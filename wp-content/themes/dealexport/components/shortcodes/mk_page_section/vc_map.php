...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            ...
            "description" => __("Please note that Smooth Scroll option should be enabled for the parallax feature function correctly. Smooth Scroll option is loctated in Theme Options > General Settings > Site Settings.", "mk_framework") ,
        ...
        array(
            "type"        => "toggle",
            "heading"     => __( "Overflow", "mk_framework" ),
            "description" => __( "If you enable this option, page section's content hides if it's bigger than page section's height.", "mk_framework" ),
            "param_name"  => "overflow",
            "value"       => "false",
            "dependency"  => array(
        ...
        array(
            "type"        => "range",
            "heading"     => __( "Page Section Maximum Height", "mk_framework" ),
