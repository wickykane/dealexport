...
$output .= '<div id="mk-icon-box-' . $id . '" class="mk-box-icon-2 ' . $el_class . ' ' . $visibility . ' box-align-' . $align . ' ' . get_viewport_animation_class( $animation ) . '">';
if ( 'icon' == $icon_type ) {
	$app_styles = '
	...
	$icon_size = ( 'inherit' != $icon_size ) ? ('width:' . $icon_size . 'px;' ) : '';
